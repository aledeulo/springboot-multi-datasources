...
class MultiDatasourcesApplicationTests {
    ...
    HttpResponse<String> insertUsers(String publicName, String privateName) throws IOException, InterruptedException {
        UsersDto body = UsersDto.builder()
                .publicUser(PublicUser.builder()
                        .name(publicName)
                        .build())
                .secondaryUser(SecondaryUser.builder()
                        .name(privateName)
                        .build())
                .build();
